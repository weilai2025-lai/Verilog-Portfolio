...
-- cin	=>  Location: PIN_M9,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF ffulladd_cla IS
...
SIGNAL \c0|c[1]~1_combout\ : std_logic;
SIGNAL \c0|c[1]~2_combout\ : std_logic;
SIGNAL \a[2]~input_o\ : std_logic;
SIGNAL \b[2]~input_o\ : std_logic;
SIGNAL \c0|c~0_combout\ : std_logic;
SIGNAL \f2|s~combout\ : std_logic;
SIGNAL \a[3]~input_o\ : std_logic;
SIGNAL \b[3]~input_o\ : std_logic;
SIGNAL \c0|c~3_combout\ : std_logic;
SIGNAL \c0|c[2]~4_combout\ : std_logic;
SIGNAL \c0|c[2]~5_combout\ : std_logic;
...
-- Equation(s):
-- \f1|s~0_combout\ = \a[1]~input_o\ $ (((\cin~input_o\ & ((\b[0]~input_o\) # (\a[0]~input_o\))) # (!\cin~input_o\ & (\b[0]~input_o\ & \a[0]~input_o\))))
...
-- Equation(s):
-- \f1|s~combout\ = \f1|s~0_combout\ $ (\b[1]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \f1|s~0_combout\,
	datad => \b[1]~input_o\,
	combout => \f1|s~combout\);

-- Location: LCCOMB_X18_Y1_N24
\c0|c[1]~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c[1]~1_combout\ = (\a[1]~input_o\) # (\b[1]~input_o\)
...
PORT MAP (
	dataa => \a[1]~input_o\,
	datad => \b[1]~input_o\,
	combout => \c0|c[1]~1_combout\);

-- Location: LCCOMB_X18_Y1_N26
\c0|c[1]~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c[1]~2_combout\ = (\c0|c[1]~1_combout\ & (\cin~input_o\ & ((\b[0]~input_o\) # (\a[0]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \c0|c[1]~1_combout\,
	datab => \cin~input_o\,
	datac => \b[0]~input_o\,
	datad => \a[0]~input_o\,
	combout => \c0|c[1]~2_combout\);
...
\c0|c~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c~0_combout\ = (\a[1]~input_o\ & ((\b[1]~input_o\) # ((\a[0]~input_o\ & \b[0]~input_o\)))) # (!\a[1]~input_o\ & (\a[0]~input_o\ & (\b[0]~input_o\ & \b[1]~input_o\)))
...
PORT MAP (
	...
	datac => \b[0]~input_o\,
	datad => \b[1]~input_o\,
	combout => \c0|c~0_combout\);

-- Location: LCCOMB_X18_Y1_N4
\f2|s\ : cycloneiv_lcell_comb
-- Equation(s):
-- \f2|s~combout\ = \a[2]~input_o\ $ (\b[2]~input_o\ $ (((\c0|c[1]~2_combout\) # (\c0|c~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \c0|c[1]~2_combout\,
	datab => \a[2]~input_o\,
	datac => \b[2]~input_o\,
	datad => \c0|c~0_combout\,
...
\c0|c~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c~3_combout\ = (\a[2]~input_o\ & ((\b[2]~input_o\) # ((\a[1]~input_o\ & \b[1]~input_o\)))) # (!\a[2]~input_o\ & (\a[1]~input_o\ & (\b[2]~input_o\ & \b[1]~input_o\)))
...
PORT MAP (
	...
	datac => \b[2]~input_o\,
	datad => \b[1]~input_o\,
	combout => \c0|c~3_combout\);

-- Location: LCCOMB_X18_Y1_N16
\c0|c[2]~4\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c[2]~4_combout\ = (\c0|c[1]~1_combout\ & ((\cin~input_o\ & ((\b[0]~input_o\) # (\a[0]~input_o\))) # (!\cin~input_o\ & (\b[0]~input_o\ & \a[0]~input_o\))))
...
PORT MAP (
	...
	datac => \b[0]~input_o\,
	datad => \a[0]~input_o\,
	combout => \c0|c[2]~4_combout\);

-- Location: LCCOMB_X18_Y1_N18
\c0|c[2]~5\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c[2]~5_combout\ = (\c0|c~3_combout\) # ((\c0|c[2]~4_combout\ & ((\b[2]~input_o\) # (\a[2]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \c0|c~3_combout\,
	datab => \c0|c[2]~4_combout\,
	datac => \b[2]~input_o\,
	datad => \a[2]~input_o\,
	combout => \c0|c[2]~5_combout\);

-- Location: LCCOMB_X18_Y1_N28
\f3|s\ : cycloneiv_lcell_comb
-- Equation(s):
-- \f3|s~combout\ = \a[3]~input_o\ $ (\b[3]~input_o\ $ (\c0|c[2]~5_combout\))
...
PORT MAP (
	datab => \a[3]~input_o\,
	datac => \b[3]~input_o\,
	datad => \c0|c[2]~5_combout\,
	combout => \f3|s~combout\);

-- Location: LCCOMB_X18_Y1_N22
\c0|cout~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|cout~0_combout\ = (\c0|c[2]~4_combout\) # ((\a[1]~input_o\ & \b[1]~input_o\))
...
-- Equation(s):
-- \c0|cout~1_combout\ = (\c0|cout~0_combout\ & ((\b[2]~input_o\) # (\a[2]~input_o\))) # (!\c0|cout~0_combout\ & (\b[2]~input_o\ & \a[2]~input_o\))
...
-- Equation(s):
-- \c0|cout~2_combout\ = (\a[3]~input_o\ & ((\b[3]~input_o\) # (\c0|cout~1_combout\))) # (!\a[3]~input_o\ & (\b[3]~input_o\ & \c0|cout~1_combout\))
